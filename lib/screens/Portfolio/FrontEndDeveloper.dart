...
class FrontEndDeveloper extends StatefulWidget {
  const FrontEndDeveloper({super.key});

  @override
  State<FrontEndDeveloper> createState() => _FrontEndDeveloperState();
}

class _FrontEndDeveloperState extends State<FrontEndDeveloper> {
  ...
  Future<List<Map<String, dynamic>>> fetchFreelanceUsers() async {
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('serviceCategory',  arrayContains: 'Front-End Developer')
        .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Front-End Developers'),
        centerTitle: true,
