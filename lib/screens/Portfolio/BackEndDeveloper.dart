...
class BackEndDeveloper extends StatefulWidget {
  const BackEndDeveloper({super.key});

  @override
  State<BackEndDeveloper> createState() => _BackEndDeveloperState();
}

class _BackEndDeveloperState extends State<BackEndDeveloper> {
 ...
 Future<List<Map<String, dynamic>>> fetchFreelanceUsers() async {
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('serviceCategory',  arrayContains: 'Back-End Developer')
        .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Back-End Developers'),
        centerTitle: true,
